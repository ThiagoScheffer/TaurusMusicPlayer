import { c as invoke } from "./core-D9mj3vOJ.js";
import { a as once, i as listen, n as emit, r as emitTo, t as TauriEvent } from "./event-SqITylZ3.js";
import { _ as PhysicalSize, d as getCurrentWindow, g as PhysicalPosition, o as Window, v as Position, y as Size } from "./window-CkH-Et5O.js";
...
var Webview = class {
	...
	* @returns A promise indicating the success or failure of the operation.
	*/
	async reparent(window$1) {
		return invoke("plugin:webview|reparent", {
			label: this.label,
			window: typeof window$1 === "string" ? window$1 : window$1.label
		});
	}
	/**
