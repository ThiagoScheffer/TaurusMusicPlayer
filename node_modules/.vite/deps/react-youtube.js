...
var require_factoryWithTypeCheckers = /* @__PURE__ */ __commonJS({ "node_modules/prop-types/factoryWithTypeCheckers.js": ((exports, module) => {
	...
	module.exports = function(isValidElement, throwOnDirectAccess$1) {
		...
		*/
		function is(x, y$1) {
			if (x === y$1) return x !== 0 || 1 / x === 1 / y$1;
			else return x !== x && y$1 !== y$1;
		}
		/**
...
var require_sister = /* @__PURE__ */ __commonJS({ "node_modules/sister/src/sister.js": ((exports, module) => {
	var Sister = function() {
		var sister = {}, events = {};
		/**
		* @name handler
...
var require_load_script = /* @__PURE__ */ __commonJS({ "node_modules/load-script/index.js": ((exports, module) => {
	module.exports = function load$1(src, opts, cb) {
...
var require_loadYouTubeIframeApi = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/dist/loadYouTubeIframeApi.js": ((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var _loadScript2 = _interopRequireDefault$3(require_load_script());
...
var require_ms = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/node_modules/ms/index.js": ((exports, module) => {
	/**
	* Helpers.
	*/
	var s = 1e3;
...
var require_debug = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/node_modules/debug/src/debug.js": ((exports, module) => {
	/**
	...
	*/
	function createDebug(namespace) {
		function debug$1() {
			...
			(debug$1.log || exports.log || console.log.bind(console)).apply(self, args);
		}
		...
		if ("function" === typeof exports.init) exports.init(debug$1);
		return debug$1;
	}
	/**
...
var require_browser = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/node_modules/debug/src/browser.js": ((exports, module) => {
	/**
	...
	*/
	function formatArgs(args) {
		var useColors$1 = this.useColors;
		args[0] = (useColors$1 ? "%c" : "") + this.namespace + (useColors$1 ? " %c" : " ") + args[0] + (useColors$1 ? "%c " : " ") + "+" + exports.humanize(this.diff);
...
var require_functionNames = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/dist/functionNames.js": ((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	/**
...
var require_eventNames = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/dist/eventNames.js": ((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	/**
...
var require_PlayerStates = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/dist/constants/PlayerStates.js": ((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = {
		BUFFERING: 3,
		ENDED: 0,
...
var require_FunctionStateMap = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/dist/FunctionStateMap.js": ((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var _PlayerStates2 = _interopRequireDefault$2(require_PlayerStates());
...
var require_YouTubePlayer = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/dist/YouTubePlayer.js": ((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var _debug2 = _interopRequireDefault$1(require_browser());
	var _functionNames2 = _interopRequireDefault$1(require_functionNames());
	var _eventNames2 = _interopRequireDefault$1(require_eventNames());
	var _FunctionStateMap2 = _interopRequireDefault$1(require_FunctionStateMap());
	...
	*/
	YouTubePlayer.proxyEvents = function(emitter) {
		var events = {};
		var _loop = function _loop$1(eventName$1) {
			var onEventName = "on" + eventName$1.slice(0, 1).toUpperCase() + eventName$1.slice(1);
			events[onEventName] = function(event) {
				debug("event \"%s\"", onEventName, event);
				emitter.trigger(eventName$1, event);
			};
		};
	...
	*/
	YouTubePlayer.promisifyPlayer = function(playerAPIReady) {
		...
		var functions = {};
		var _loop2 = function _loop2$1(functionName$1) {
			if (strictState && _FunctionStateMap2.default[functionName$1]) functions[functionName$1] = function() {
				for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
				return playerAPIReady.then(function(player) {
					var stateInfo = _FunctionStateMap2.default[functionName$1];
					var playerState = player.getPlayerState();
					var value = player[functionName$1].apply(player, args);
			...
			else functions[functionName$1] = function() {
				for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) args[_key2] = arguments[_key2];
				return playerAPIReady.then(function(player) {
					return player[functionName$1].apply(player, args);
				});
			};
		};
...
var require_dist = /* @__PURE__ */ __commonJS({ "node_modules/youtube-player/dist/index.js": ((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
